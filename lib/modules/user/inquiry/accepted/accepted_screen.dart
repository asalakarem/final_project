...
class AcceptedScreen extends StatelessWidget {
      ...
      builder: (BuildContext context, MainStates state) {
        ...
        return Scaffold(
          ...
          body: ListView.builder(
            itemBuilder:
                (context, index) =>
                    buildAcceptedItem(cubit.acceptedList[index], context, index),
  ...
  Widget buildAcceptedItem(AcceptedModel model, BuildContext context, int index) =>
      Container(
          ...
          children: [
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () => MainCubit.get(context).changeInProgress(index, 'accepted'),
                  child: CircleAvatar(
                    radius: 15.0,
                    backgroundColor: const Color(0xff6C2C2C),
                    child: MainCubit.get(context).isCollapse['accepted']! &&
